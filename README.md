# Lab 3 — DSAR (Codespaces‑Ready): Data Cleaning

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/jl2578/Lab3?quickstart=1)

This repo is preconfigured for **GitHub Codespaces** with Python, Jupyter, **GitHub Copilot**, and **Data Wrangler**.
...
2. Add your **Lab3.ipynb** and the dataset (e.g., `L3dataset.csv`) to the repo root.
...
- Students add the notebook and dataset manually at the repo root.
